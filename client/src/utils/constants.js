...
export const GROUP_MODES = [
    { value: 'partner', label: 'Me + Partner', description: 'Design together with your significant other' },
    { value: 'roommates', label: 'Roommates', description: 'Create a shared space everyone loves' },
    { value: 'family', label: 'Family', description: 'Find a style that works for the whole family' },
    { value: 'custom', label: 'Custom', description: 'Set up your own group' }
];
