...
const getInTouchImg = '/design/get in touch.jpeg';

// Vibe images for CircularGallery & InfiniteMenu
const vibeImages = {
    bohemian: '/Bohemian/Bedroom 20/1.jpg',
    scandinavian: '/Scandinavian/Bedroom 20/1.jpg',
    minimalist: '/Minimalist/Bedroom 20/1.jpg',
    industrial: '/Industrial/Bedroom 20/1.jpg',
    modern_luxury: '/ModernLuxury/Bedroom 20/1.jpg',
    traditional: '/Traditional/Bedroom 20/1.jpg',
    maximalist: '/Maximalist/Bedroom 20/1.jpg',
};
...
const reviewImages = Array.from({ length: 15 }, (_, i) => `/review/${i + 1}.png`);
