    ...
    if (checkoutItems.length === 0 && !isProcessing && paymentFlow === 'idle') {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 text-center">
                <h2 className="text-3xl font-display font-bold text-dark mb-6">Your checkout is empty</h2>
            ...
            <main className="checkout-main">
                    ...
                    <div className="checkout-section">
                        {currentSection !== 1 && selectedAddress ? (
                            ...
                            <div className="section-expanded">
                                ...
                                <button
                                    className="text-primary text-sm font-semibold flex items-center gap-1 mt-2 hover:text-primary/80 transition-colors"
                        ...
                        <div className={`section-expanded ${currentSection < 3 ? 'opacity-40 pointer-events-none' : ''}`}>
                            ...
                            <div className="space-y-4">
                                {uniqueCheckoutItems.map((item, idx) => (
                                    <div key={idx} className="flex gap-4 p-4 border rounded-xl bg-[#faf7f4]" style={{ borderColor: 'rgba(139,99,71,0.12)' }}>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-4 mt-1">
                                                ...
                                                <span className="text-xs text-gray-500 bg-primary/10 text-primary px-2 py-0.5 rounded-full">Qty: {item.checkoutQuantity}</span>
                                            </div>
                                            <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-2">Authenticated by VibeSpace</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                ...
                <div className="sidebar-summary">
                    <div className="summary-card">
                        ...
                        <p className="text-[10px] text-gray-400 text-center mb-4 leading-tight">
                            By placing your order, you agree to VibeSpace's
                            <span className="text-primary"> terms and conditions</span>.
                        </p>

                        <div className="space-y-2 mb-4 pt-4" style={{ borderTop: '1px solid rgba(139,99,71,0.15)' }}>
                            <h4 className="font-bold text-sm text-dark mb-3">Order Summary</h4>
                            ...
                            <div className="summary-row">
                                <span>Delivery:</span>
                                <span>{delivery === 0 ? <span className="text-green-600 font-semibold">Free</span> : `$${delivery.toFixed(2)}`}</span>
                            </div>
                        ...
                        <div className="p-3 rounded-lg text-[10px] text-primary font-medium" style={{ background: 'rgba(139,99,71,0.07)' }}>
