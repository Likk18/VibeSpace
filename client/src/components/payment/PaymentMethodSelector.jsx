...
const PaymentMethodSelector = ({ selectedMethod, onMethodChange, walletBalance, orderAmount, onNewCardData, onBankSelect, onUpiIdChange, savedCards, savedUpis, onSaveCardToggle, onSaveUpiToggle }) => {
