  ...
  initTexture() {
    ...
    Promise.all(
        ...
        (item) =>
          new Promise((resolve) => {
            ...
            img.onerror = () => {
              ...
              resolve(img); // Still resolve so Promise.all completes
            }
            img.src = item.image;
          })
      )
      ...
      images.forEach((img, i) => {
        ...
        if (img.width && img.height) { // Only draw if loaded correctly
...
const InfiniteMenu = ({ items = [], scale = 1.0 }) => {
  ...
  return (
    <div className="relative w-full h-[600px] overflow-hidden rounded-2xl" style={{ backgroundColor: '#F5EFE6' }}>
      <canvas
      ...
      {activeItem && (
        ...
        `}
            style={{ backgroundColor: '#8B6347', border: '4px solid #F5EFE6' }}
          >
